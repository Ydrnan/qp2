! BEGIN_PROVIDER [ complex*16, psi_energy_c, (N_states) ]
!&BEGIN_PROVIDER [ complex*16, psi_s2_c, (N_states) ]
!  implicit none
!  BEGIN_DOC
...
!  END_DOC
!  call u_0_HS2_u_0(psi_energy_c,psi_s2_c,psi_coef_c,N_det,psi_det,N_int,N_states,psi_det_size)
!  integer :: i
!  do i=N_det+1,N_states
!    psi_energy(i) = (0.d0,0d0)
!    psi_s2(i) = (0.d0,0d0)
!  enddo
!END_PROVIDER
!
!BEGIN_PROVIDER [ complex*16, psi_energy_with_nucl_rep_c, (N_states) ]
! implicit none
! BEGIN_DOC
! ! Energy of the wave function with the nuclear repulsion energy.
! END_DOC
! psi_energy_with_nucl_rep_c(1:N_states) = psi_energy_c(1:N_states) + dcmplx(nuclear_repulsion,0d0)
!END_PROVIDER
